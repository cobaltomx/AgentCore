...
REGLAS: nunca inventes propiedades, precios ni disponibilidad — usa solo lo que devuelva search_products. Si no hay match, dilo y ofrece alternativas cercanas (otra zona/presupuesto). Mostrar propiedades y agendar visitas NO tiene costo.`;
    }
